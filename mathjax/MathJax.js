...
if (document.getElementById && document.childNodes && document.createElement) {
	...
	(function(d) {
		...
		removeHttp : new RegExp("^" + TK.basepath),
		storeLocal : {
		    "/common/mathjax/config/TeX-AMS_HTML.js" : true,
		    "/common/mathjax/jax/output/SVG/config.js" : true,
		    "/common/mathjax/jax/output/SVG/jax.js" : true,
		    "/common/mathjax/jax/output/SVG/fonts/TeX/fontdata.js" : true,
		    "/common/mathjax/jax/output/SVG/fonts/TeX/Size2/Regular/Main.js" : true,
		    "/common/mathjax/jax/output/SVG/autoload/mtable.js" : true,
		    "/common/mathjax/jax/output/SVG/fonts/TeX/Main/Bold/Main.js" : true,
		    "/common/mathjax/jax/output/SVG/fonts/TeX/Main/Bold/BasicLatin.js" : true,
		    "/common/mathjax/config/default.js" : true,
		    "/common/mathjax/jax/input/TeX/config.js" : true,
		    "/common/mathjax/extensions/tex2jax.js" : true,
		    "/common/mathjax/jax/element/mml/jax.js" : true,
		    "/common/mathjax/jax/input/TeX/jax.js" : true,
		    "/common/mathjax/extensions/MathEvents.js" : true,
		    "/common/mathjax/extensions/TeX/AMSmath.js" : true,
		    "/common/mathjax/extensions/MathMenu.js" : true,
		    "/common/mathjax/extensions/MathZoom.js" : true
		},
		loader : {
		    JS : function(i, k) {
			var that = this;
			var j = a.Callback([ "loadTimeout", that, i ]);
			var url = i.replace(this.removeHttp, "");
			if (that.storeLocal[url] === true
				&& (typeof TK === "object")
	...
	MathJax.Hub = {
		...
		while (c.j < c.jaxIDs.length) {
			...
			try {
			    ...
			    if (!b.restart) {
				MathJax.Message.Set("Error preparing " + e
					+ " output (" + f + ")", null, 600);
		...
		this.lastError = c;
		this.signal.Post([ "Math Processing Error", a, c ])
	    },
	...
	MathJax.Hub.Startup = {
		...
		if (a["v1.0-compatible"] && (a.jax || []).length === 0
			&& !this.params.config && (a.config || []).length === 0) {
		    return MathJax.Ajax.Require(this.URL("extensions",
			    "v1.0-warning.js"))
		}
	    },
	    Cookie : function() {
		return this.queue.Push([ "Post", this.signal, "Begin Cookie" ],
			...
			}, MathJax.Hub.config ], [ "Post", this.signal,
				"End Cookie" ])
	    },
	    Styles : function() {
		...
		if (!MathJax.Extension.MathMenu) {
		    setTimeout(MathJax.Callback([ "Require", MathJax.Ajax,
			    "[MathJax]/extensions/MathMenu.js", {} ]), 1000)
		}
	    ...
	    c.Browser
			...
			Firefox : function(j) {
			    ...
			    j.isMobile = (navigator.appVersion
				    .match(/Android/i) != null || navigator.userAgent
				    .match(/ Fennec\//) != null)
			},
			Opera : function(i) {
